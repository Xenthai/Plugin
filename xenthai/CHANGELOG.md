...
- **`--emit <file>`** prints a staged file's bytes, minus the final newline, and nothing else. It
  ...
  no byte generated by the model. `INSTALL.md` §5b carries the hook, written per company into
  `<company root>/.claude/settings.json`. Verified end to end in a cloud session: 19,973 bytes,
  `fileSize` equal, SHA-256 equal.
