# 03-procesos/INDICE (A2 §7) — <empresa>

> Entrada directa de A3. Un archivo por proceso vive en `PXX-<nombre>.md`; process-map lo
> escribe, process-access lo profundiza con dolor, accesos y autorización.
