# 03-procesos/PXX-nombre (A2 §7) — <empresa>

> Plantilla de un archivo por proceso. `process-map` la duplica como `P01-<nombre>.md`,
> `P02-<nombre>.md`… — un archivo real por proceso, nunca este archivo con varios bloques
> dentro. El inventario y el orden por costo mensual viven en
> [INDICE.md](INDICE.md); `process-access` profundiza esta ficha con dolor priorizado y
> viabilidad de automatización en [05-backlog.md](../05-backlog.md).
